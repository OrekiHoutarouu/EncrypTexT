...
tabview = customtkinter.CTkTabview(app, width=400)
tabview.pack()
...
binary_encrypt_button = customtkinter.CTkButton(tabview.tab("Binary"), text="Encrypt")
binary_encrypt_button.pack(pady=50)

binary_decrypt_button = customtkinter.CTkButton(tabview.tab("Binary"), text="Decrypt")
