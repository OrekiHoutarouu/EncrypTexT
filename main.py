...
zenit_polar_encrypt_button = customtkinter.CTkButton(tabview.tab("Octal"), text="Encrypt", command=utilities.get_octal_encrypted_value, corner_radius=10)
zenit_polar_encrypt_button.pack(pady=50)

zenit_polar_decrypt_button = customtkinter.CTkButton(tabview.tab("Octal"), text="Decrypt", command=utilities.get_octal_decrypted_value, corner_radius=10)
